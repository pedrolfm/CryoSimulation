...
class Cryo2Probes(ScriptedLoadableModuleLogic):
  ...
  def optimizationCryo(self, N, Kd):
    ...
    res = scipy.optimize.minimize(Fun, x0, method='Nelder-Mead', options={'fatol': 0.5, 'xatol': 1.0, 'maxiter': 1200, 'maxfev': 10900})
  ...
  def TestFunction(self, inputVolume, inputVolume2, inputVolume3, inputVolume4, StdevError, NoOfProbes, Kd, N, outputLabel):
    ...
    for j in range(0, 5):
      for i in range(0, 5):
        ...
        saveHTA[i] = self.Metric[2]
        saveMass[i] = 1
        resultFile.write("02 ; %02d ; %02d ; %02f ; %02d ; %02f ; %02f ; %r \n" % (
        N, self.DiceGain, self.sdterr, self.Metric[0], self.Metric[2], self.Metric[3], self.converge))
...
#==============================
    ...
    return
    #resultFileName = "Results-N%02d-K%02d-P2-r42" % (N, self.DiceGain)
    #resultFilePath = '/Users/pedro/Documents/Test-slicer' + '/' + resultFileName
    ...
    #    saveHTA[i] = self.Metric[2]
    #    saveMass[i] = 1
    #    resultFile.write("02 ; %02d ; %02d ; %02f ; %02d ; %02f ; %02f ; %02f ; %02f ; %02f ; %02f ; %02f ; %02f \n" % (
...
#
  ...
  def optimizationCryo(self, N, Kd):
    ...
    res = scipy.optimize.minimize(Fun, x0, method='Nelder-Mead',
                                  options={'fatol': 0.2, 'xatol': 0.1, 'maxiter': 1600, 'maxfev': 19200})
  ...
  def TestFunction(self, inputVolume, inputVolume2, inputVolume3, inputVolume4, StdevError, NoOfProbes, Kd, N, outputLabel):
    ...
    resultFileName = "ResultsR42-3ProbesE12345-testxatol-1-fatol05"
    resultFilePath = '/Users/pedro/Documents/Test-slicer' + '/' + resultFileName
    ...
    print("\n========\n")
    self.sdterr = 7
    self.Metric = self.Probability(X, 1000)
    print(self.Metric)
    self.Metric = self.Probability(X, 1000)
    print(self.Metric)
    self.Metric = self.Probability(X, 1000)
